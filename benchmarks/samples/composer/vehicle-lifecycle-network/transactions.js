...
*        "callback" : "benchmarks/samples/composer/vehicle-lifecycle-network/transactions.js"
*      }
*      {
*        "label" : "vehicle-lifecycle-network",
*        "txNumber" : [50],
...
*        "callback" : "benchmarks/samples/composer/vehicle-lifecycle-network/transactions.j"
*      }
*      {
*        "label" : "vehicle-lifecycle-network",
*        "txNumber" : [50],
...
const removeExisting = require('./utils/composer-test-utils').clearAll;
const os = require('os');
